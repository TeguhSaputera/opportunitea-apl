...
<html lang="en">
  ...
  <div class="container justify-content-center">
      <div class="not-member text-center" style="margin-top:50px;">
          ...
          <img src="assets/image/repair.png" width="40%" alt="">
          <p style="font-family: 'poppins'; ">username dan password yg di input tidak terdaftar pada database Opportunitea, segera kembali ke login</p>
